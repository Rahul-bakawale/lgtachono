                ...
                <PopularCardSection
                  ...
                  additionalText={
                    items?.additionalText
                      ? (() => {
                          const listItems = [];
                          items.additionalText.forEach((text, index) => {
                            console.log("text", text);
                            listItems.push(<li key={index}>{text}</li>); // Push each element to the array
                          });
                          return listItems; // Return the array of JSX elements
                        })()
                      : ""
                  }
                  imgSrc={items?.imgSrc}
