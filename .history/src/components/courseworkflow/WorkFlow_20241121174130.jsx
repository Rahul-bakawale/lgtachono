...
import Number3 from "../../assets/images/Group (3).png";
import Number4 from "../../assets/images/Group (1).png";
import Step from "./Step"; // Import the reusable Step component
...
const CourseWorkFlow = () => {
  return (
    ...
    >
      {/* Title Row */}
      <Row className="text-center mb-4">
        <h2 style={{ color: "rgba(239, 158, 72, 1)" }}>Whats the function</h2>
        <h1 style={{ fontWeight: "700", color: "rgba(15, 33, 55, 1)" }}>
          Let’s see how it works
        </h1>
      </Row>
