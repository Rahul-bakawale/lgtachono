                ...
                <div key={index}>
                  <Card.Subtitle
                    ...
                    style={{
                      font: "DM Sans",
                      fontSize: "55px",
                      lineHeight: "100px", // Fixed the typo '100x' to '100px'
                      color: "rgba(2, 7, 62, 1)",
                    }}
                  >
                    {content.title}
                  ...
                  {/* Optional: You can also render Card.Text if there's a need for more content */}
                  {index === 1 && (
                    <Card.Text
                      style={{
                        font: "DM Sans",
                    ...
                    >
                      <span>{content.subtitle ? ontent.subtitle : ""}</span>
                    </Card.Text>
                  )}
                </div>
              ))}
